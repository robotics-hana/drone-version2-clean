...
def plot_group(runs, title="Group Plot"):
    ...
    ax3d.set_ylim(-0.25, 1.25)
    ax3d.set_xlim(-0.25, 1.25)
    ax3d.set_zlim(1.5, 2.5) 
    ...
    ax_xy.set_ylim(-0.25, 1.25)
    ax_xy.set_xlim(-0.25, 1.25)
...
if __name__ == "__main__":
    # 组1：固定 h = 80，不同 s
    runs_samples = load_runs("EE_Square_*.npz", label_mode="samples")
    if not runs_samples:
