...
class Platform:
    ...
    def _tick_fixed(self, act):
        ...
        self.pf_i += 1
        if ORACLEYAW[0] == 2 and bool(r.data.eq_active[r.weld]):
            pass          # variant 2: release the pin once welded -- the
                          # bearing to a held object degenerates and froze the
                          # carry heading in variant 1 (picked 5/20, placed 0)
        elif ORACLEYAW[0] and self.kind != "nav":
